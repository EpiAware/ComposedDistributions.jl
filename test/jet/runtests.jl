...
if @isdefined(JET_REPORT_FILTER)
    result = JET.report_package(ComposedDistributions;
        target_modules = (ComposedDistributions,))
    ...
    JET.test_package(ComposedDistributions; target_modules = (ComposedDistributions,))
end

...
@testitem "recur seam: per-step kernels drive the convolution surface" setup=[DelayMasses] begin
    using Distributions
    ...
    kernels = map(od -> delay_masses(od, maxlag), ods)

...
@testitem "convolved: univariate one_of marginal drives a series" begin
    using Distributions
...
@testitem "convolved: Compete marginal (any-event time) drives a series" begin
    using Distributions
...
@testitem "convolved: Parallel / Choose error informatively" begin
    using Distributions

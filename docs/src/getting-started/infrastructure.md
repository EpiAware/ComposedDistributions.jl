...
`ComposedDistributions` adopts shared configuration and test infrastructure from
...
Two pieces keep `ComposedDistributions` aligned with the kit.
...
update("path/to/ComposedDistributions.jl")
```

...
- [`composed_params`](@ref) — the free parameters flattened to a Tables.jl table, one row per parameter.
...
composed_params(tree)             # a Tables.jl table of the free parameters
```

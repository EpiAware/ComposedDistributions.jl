...
```@meta
EditURL = "https://github.com/EpiAware/ComposedDistributions.jl/blob/main/NEWS.md"
```
...
See [GitHub Releases](https://github.com/EpiAware/ComposedDistributions.jl/releases) for minor/patch
release information.

...
using ..ComposedDistributions: ComposedDistributions, Sequential, Parallel,
                               ...
                               event, event_names, event_tree, composed_params,
...
- `params` works and `composed_params` is a Tables.jl table
  (`Tables.istable(composed_params(d))`);
...
function _check_params(d)
    @testset "params / composed_params" begin

...
[`params_table`](@ref) / [`event_names`](@ref) / [`event`](@ref), and edit the
tree with [`update`](@ref) / [`prune`](@ref) / [`splice`](@ref). Attach
...
export params_table, event_names, event_tree, event, inspect,

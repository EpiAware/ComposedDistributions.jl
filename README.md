...
- [ConvolvedDistributions.jl](https://github.com/EpiAware/ConvolvedDistributions.jl) is re-exported, so convolution (`convolved`, `difference`) and quadrature are reachable through ComposedDistributions alone.
